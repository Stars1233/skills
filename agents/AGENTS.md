...
These skills are:
 ...
 - train-cross-encoder -> "skills/train-cross-encoder/SKILL.md"
 - train-sentence-transformer -> "skills/train-sentence-transformer/SKILL.md"
 - train-sparse-encoder -> "skills/train-sparse-encoder/SKILL.md"
